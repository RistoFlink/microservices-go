...
import (
	...
	"encoding/json"
	"errors"
	"github.com/RistoFlink/broker/event"
	"github.com/RistoFlink/broker/logs"
...
func (app *Config) authenticate(w http.ResponseWriter, a AuthPayload) {
	...
	// make sure to get the correct status code back
...
func (app *Config) sendMail(w http.ResponseWriter, message MailPayload) {
	...
	var payload jsonResponse
	payload.Error = false
	payload.Message = "Mail sent to " + message.To
